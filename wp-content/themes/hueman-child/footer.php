...
?>
  ...
  <nav class="nav-container group" id="nav-footer" data-menu-id="<?php echo hu_get_menu_id('footer'); ?>" data-menu-scrollable="false">
    ...
    <div class="nav-text">
      <?php apply_filters('hu_mobile_menu_text', ''); //put your mobile menu text here
?>
    </div>
    <div class="nav-wrap">
      <?php
...
?>
  ...
  <section class="container" id="footer-bottom">
    <div class="container-inner">
      ...
      <div class="hu-pad group" id='kontakt'>
        <div class="grid one-half">
          <h1 class="boja-teksta">Kontakt medžlis Novi Pazar
          </h1>
          <p class="boja-teksta">
            <i class="fas fa-envelope">
            </i> muftijstvosndzacko@hotmail.com
          </p>
          <p class="boja-teksta">
        ...
        <div class="grid last kontakt-desno">
          <h1 class="boja-teksta">Kontakt medžlis Rožaje
          </h1>
          <p class="boja-teksta">
            <i class="fas fa-envelope">
            </i> muftijstvosndzacko@hotmail.com
      ...
      <div class="hu-pad group">
        <div class="grid one-half">
          ...
          <div id="copyright">
            <p>
              <?php echo apply_filters('hu_parse_template_tags', wp_kses_post(hu_get_option('copyright'))); ?>
            </p>
          </div>
          <!--/#copyright-->
